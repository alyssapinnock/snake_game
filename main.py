...
class Apple:
    ...
    def move(self):
        #for these, may have to change the parameters based on the size of the game screen
        #otherwise, the apple will "disappear," aka appear off-screen
...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Snake Game by Alyssa Pinnock :)")
